...
const HeroGrayscale: React.FC = () => {
  const handleGoogleSignIn = () => {
    console.log('Google Sign In clicked - Grayscale');
  };

  const scrollToDetails = () => {
    console.log('Scroll to details clicked - Grayscale');
  };
  ...
  return (
    <Hero
      ...
      shaderPalette="grayscale"
    />
  );
};

export default HeroGrayscale;
