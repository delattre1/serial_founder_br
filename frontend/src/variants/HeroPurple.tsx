...
const HeroPurple: React.FC = () => {
  const handleGoogleSignIn = () => {
    console.log('Google Sign In clicked - Purple');
  };

  const scrollToDetails = () => {
    console.log('Scroll to details clicked - Purple');
  };
  ...
  return (
    <Hero
      ...
      shaderPalette="purple"
    />
  );
};

export default HeroPurple;
