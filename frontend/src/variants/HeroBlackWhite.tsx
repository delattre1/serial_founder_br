...
const HeroBlackWhite: React.FC = () => {
  const handleGoogleSignIn = () => {
    console.log('Google Sign In clicked - Black & White');
  };

  const scrollToDetails = () => {
    console.log('Scroll to details clicked - Black & White');
  };
  ...
  return (
    <Hero
      ...
      shaderPalette="blackwhite"
    />
  );
};

export default HeroBlackWhite;
